...
const Category = (props: Props) => {
  ...
  const onSelect = (text) => {
    if (text == "디지털기기") {
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("디지털기기");
    } else if (text == "생활가전") {
      setSelect1(false);
      setSelect2(!select2);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("생활가전");
    } else if (text == "가구/인테리어") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(!select3);
      setSelect4(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("가구/인테리어");
    } else if (text == "유아동") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("유아동");
    } else if (text == "생활/가공식품") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      setSelect4(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("생활/가공식품");
    } else if (text == "유아도서") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("유아도서");
    } else if (text == "스포츠/레져") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("스포츠/레져");
    } else if (text == "여성잡화") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("여성잡화");
    } else if (text == "여성의류") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("여성의류");
    } else if (text == "남성패션/잡화") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      setSelect4(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("남성패션/잡화");
    } else if (text == "게임/취미") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("게임/취미");
    } else if (text == "뷰티/미용") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("뷰티/미용");
    } else if (text == "반려동물용품") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("반려동물용품");
    } else if (text == "도서/티켓/음반") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
      setSelect4(false);
      ...
      setSelect15(false);
      setSelect16(false);
      props.getSelectInformation("도서/티켓/음반");
    } else if (text == "식물") {
      setSelect1(false);
      setSelect2(false);
      setSelect3(false);
